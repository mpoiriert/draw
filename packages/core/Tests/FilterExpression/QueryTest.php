...
class QueryTest extends TestCase
{
    ...
    public function testWhere(): void
    {
        $this->assertSame(
            $this->object,
            $this->object->where($expression = $this->createStub(Expression::class))
        );
    ...
    public function testAndWhereNoExpressionSet(): void
    {
        $this->assertSame(
            $this->object,
            $this->object->andWhere($expression = $this->createStub(Expression::class))
        );
    ...
    {
        $this->object->andWhere($expression1 = $this->createStub(Expression::class));
        $this->object->andWhere($expression2 = $this->createStub(Expression::class));
    ...
    public function testOrWhereNoExpressionSet(): void
    {
        $this->assertSame(
            $this->object,
            $this->object->orWhere($expression = $this->createStub(Expression::class))
        );
    ...
    {
        $this->object->orWhere($expression1 = $this->createStub(Expression::class));
        $this->object->orWhere($expression2 = $this->createStub(Expression::class));
