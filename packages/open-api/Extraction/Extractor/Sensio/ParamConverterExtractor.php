...
namespace Draw\Component\OpenApi\Extraction\Extractor\Sensio;
...
class ParamConverterExtractor implements ExtractorInterface
{
    ...
    private function getDeserializationGroups(ParamConverter $paramConverter): ?array
    {
    ...
    private function getValidationGroups(ParamConverter $paramConverter): ?array
    {
        $options = $paramConverter->getOptions();
