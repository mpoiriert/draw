...
namespace Draw\Bundle\OpenApiBundle\Listener;
...
final class OpenApiEventSubscriber implements EventSubscriberInterface
{
    ...
    {
        yield PreDumpRootSchemaEvent::class => ['addHeaders', 255];
    }
