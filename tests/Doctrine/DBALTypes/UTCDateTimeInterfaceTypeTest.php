...
/**
 * @covers \Draw\Bundle\SonataExtraBundle\Doctrine\DBALTypes\UTCDateTimeInterfaceType
 */
class UTCDateTimeInterfaceTypeTest extends TestCase
{
    /**
    ...
    public function testConvert(): void
    {
        ...
        $this->assertSame('2021-07-07 14:00:00', $result['date_of_birth'], 'All dates should be stored in UTC timezone');
